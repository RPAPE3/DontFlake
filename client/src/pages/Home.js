            ...
            <Col
              ...
              <div>
                ...
                <div style={{ marginTop: '10%', textAlign: 'center',  }}>
                  ...
                  <div>
                    <Button style={{ width: '20vh', borderStyle: 'solid', marginTop: '2vh', borderColor:'black', backgroundColor: "#a64dff", boxShadow: '5px 5px grey', color:'white' }} variant='warning'>Friends</Button>
                  </div>
                  <div>
              ...
              <div className=" mt-auto" style={{marginBottom: '10%'}}>
                <button type="button" className="btn mt-4" style={{ width: '20vh', borderStyle: 'solid', marginTop: '2vh', backgroundColor: "#a64dff", borderColor:'black', boxShadow: '5px 5px grey', color:'white'}}>
